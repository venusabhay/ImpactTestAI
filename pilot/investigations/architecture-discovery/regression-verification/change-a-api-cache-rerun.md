...
*Generated 2026-08-27T16:35:17.551181+00:00Z from repository at `/tmp/rerun-a`, comparing working tree against `main` (HEAD `9515655bdb`).*
...
--------------------------------|---------|----------|---------|---------|-------------------
  POST /api/users/login
    ✓ should login with valid credentials (328 ms)
    ✓ should not login with invalid email (150 ms)
    ✓ should not login with invalid password (279 ms)
  GET /api/users/profile
    ✓ should get user profile with valid token (147 ms)
    ✓ should not get profile without token (153 ms)
    ✓ should not get profile with invalid token (200 ms)
  GET /api/users
    ✓ should get all users as admin (276 ms)
    ✓ should not get all users as regular user (275 ms)
    ✓ should not get all users without token (328 ms)
  PATCH /api/users/:id/role
    ✓ should update user role as admin (308 ms)
    ✓ should not update role without authorization (267 ms)
  DELETE /api/users/:id
    ✓ should delete user as admin (288 ms)
    ✓ should not delete user without authorization (271 ms)
    ✓ should return 404 for non-existent user (274 ms)

Test Suites: 1 passed, 1 total
Tests:       18 passed, 18 total
Snapshots:   0 total
Time:        15.92 s, estimated 18 s
Ran all test suites.
```
</details>
