...
*Generated 2026-08-27T16:21:16.454739+00:00Z from repository at `/Users/abhay/git-venusabhay/social-media-mini`, comparing working tree against `HEAD` (HEAD `b6fd0644e0`).*
...
(node:39665) ExperimentalWarning: VM Modules is an experimental feature and might change at any time
(Use `node --trace-warnings ...` to show where the warning was created)
FAIL ./verify-cross-service.integration.test.js (12.745 s)
...
> node --experimental-vm-modules node_modules/jest/bin/jest.js --detectOpenHandles --forceExit
    ...
    ✓ should reject request without token (84 ms)
  Post Service - GET /:postId
    ✓ should get post by ID (50 ms)
    ✓ should return 404 for non-existent post (44 ms)
  Post Service - PUT /:postId
    ✓ should update own post (50 ms)
    ✓ should not update another user's post (37 ms)
  Post Service - DELETE /:postId
    ✓ should delete own post (49 ms)
    ✓ should not delete another user's post (47 ms)
  Post Service - PUT /:postId/like
    ✓ should like a post (66 ms)
    ✓ should not like same post twice (70 ms)
  Post Service - PUT /:postId/unlike
    ✓ should unlike a post (49 ms)
  Post Service - POST /:postId/comments
    ✓ should add a comment to post (98 ms)
    ✓ should not add empty comment (52 ms)
...
(node:39927) ExperimentalWarning: VM Modules is an experimental feature and might change at any time
(Use `node --trace-warnings ...` to show where the warning was created)
PASS ./user.test.js (15.01 s)
  User Service - GET /me
    ✓ should get current user profile (629 ms)
    ✓ should reject request without token (71 ms)
  User Service - PUT /me
    ✓ should update user profile (124 ms)
    ✓ should not update email (66 ms)
    ✓ should reject request without token (31 ms)
  User Service - GET /:userId
    ✓ should get user by ID (30 ms)
    ✓ should return 404 for non-existent user (33 ms)
  User Service - GET /search
    ✓ should search users by name (62 ms)
    ✓ should return empty array for no matches (76 ms)
    ✓ should require query parameter (60 ms)
