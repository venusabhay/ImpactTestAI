...
*Generated 2026-08-27T17:34:17.821489+00:00Z from repository at `/tmp/rerun-a3`, comparing working tree against `main` (HEAD `9515655bdb`).*
...
--------------------------------|---------|----------|---------|---------|-------------------
  POST /api/users/login
    ✓ should login with valid credentials (348 ms)
    ✓ should not login with invalid email (173 ms)
    ✓ should not login with invalid password (288 ms)
  GET /api/users/profile
    ✓ should get user profile with valid token (153 ms)
    ✓ should not get profile without token (144 ms)
    ✓ should not get profile with invalid token (186 ms)
  GET /api/users
    ✓ should get all users as admin (290 ms)
    ✓ should not get all users as regular user (282 ms)
    ✓ should not get all users without token (287 ms)
  PATCH /api/users/:id/role
    ✓ should update user role as admin (325 ms)
    ✓ should not update role without authorization (283 ms)
  DELETE /api/users/:id
    ✓ should delete user as admin (308 ms)
    ✓ should not delete user without authorization (378 ms)
    ✓ should return 404 for non-existent user (301 ms)

Test Suites: 1 passed, 1 total
Tests:       18 passed, 18 total
Snapshots:   0 total
Time:        16.019 s, estimated 111 s
Ran all test suites.
```
</details>
