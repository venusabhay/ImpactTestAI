...
*Generated 2026-08-27T17:35:13.821726+00:00Z from repository at `/tmp/rerun-c3`, comparing working tree against `main` (HEAD `9515655bdb`).*
...
--------------------------------|---------|----------|---------|---------|-------------------
  POST /api/users/login
    ✓ should login with valid credentials (275 ms)
    ✓ should not login with invalid email (155 ms)
    ✓ should not login with invalid password (276 ms)
  GET /api/users/profile
    ✓ should get user profile with valid token (162 ms)
    ✓ should not get profile without token (157 ms)
    ✓ should not get profile with invalid token (195 ms)
  GET /api/users
    ✓ should get all users as admin (303 ms)
    ✓ should not get all users as regular user (457 ms)
    ✓ should not get all users without token (287 ms)
  PATCH /api/users/:id/role
    ✓ should update user role as admin (334 ms)
    ✓ should not update role without authorization (323 ms)
  DELETE /api/users/:id
    ✓ should delete user as admin (340 ms)
    ✓ should not delete user without authorization (340 ms)
    ✓ should return 404 for non-existent user (304 ms)
