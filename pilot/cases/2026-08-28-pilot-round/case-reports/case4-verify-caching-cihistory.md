...
*Generated 2026-08-28T18:41:25.798967+00:00Z from repository at `/Users/abhay/git-venusabhay/social-media-mini`, comparing working tree against `main` (HEAD `b6fd0644e0`).*
...
- Relevant job history for `auth-service`: 6 run(s) matched -- 0 failed, 2 cancelled (due to an unrelated sibling job, not this service), 4 passed
- **Historical signal:** No confirmed CI job failures specific to this service were found across 6 relevant run(s) examined (2 job(s) were CANCELLED because a different, unrelated job in the same run failed -- that is not evidence against this service, and is not counted as a failure).
- What this does NOT establish:
  - Could not fetch job detail for run 19512187846: The read operation timed out
...
(node:53401) ExperimentalWarning: VM Modules is an experimental feature and might change at any time
(Use `node --trace-warnings ...` to show where the warning was created)
PASS ./auth.test.js (16.121 s)
FAIL ./verify-cross-service.integration.test.js (9.68 s)
...
> node --experimental-vm-modules node_modules/jest/bin/jest.js --detectOpenHandles --forceExit
    ...
    ✓ should get all posts (103 ms)
    ✓ should reject request without token (37 ms)
  Post Service - GET /:postId
    ✓ should get post by ID (33 ms)
    ✓ should return 404 for non-existent post (37 ms)
  Post Service - PUT /:postId
    ✓ should update own post (62 ms)
    ✓ should not update another user's post (27 ms)
  Post Service - DELETE /:postId
    ✓ should delete own post (44 ms)
    ✓ should not delete another user's post (37 ms)
  Post Service - PUT /:postId/like
    ✓ should like a post (41 ms)
    ✓ should not like same post twice (56 ms)
  Post Service - PUT /:postId/unlike
    ✓ should unlike a post (54 ms)
  Post Service - POST /:postId/comments
    ✓ should add a comment to post (64 ms)
    ✓ should not add empty comment (29 ms)
...
(node:53568) ExperimentalWarning: VM Modules is an experimental feature and might change at any time
(Use `node --trace-warnings ...` to show where the warning was created)
PASS ./user.test.js (11.876 s)
  User Service - GET /me
    ✓ should get current user profile (282 ms)
    ✓ should reject request without token (69 ms)
  User Service - PUT /me
    ✓ should update user profile (147 ms)
    ✓ should not update email (59 ms)
    ✓ should reject request without token (29 ms)
  User Service - GET /:userId
    ✓ should get user by ID (34 ms)
    ✓ should return 404 for non-existent user (33 ms)
  User Service - GET /search
    ✓ should search users by name (75 ms)
    ✓ should return empty array for no matches (56 ms)
    ✓ should require query parameter (43 ms)
...
---
*Run ID: `20260828T183918Z-07ef5c99`. Tool version: `0.8.0-pilot`. Risk/validation rules: `repo-plus-ci-plus-cross-service-plus-discovery-v9`. Re-running this analysis with the same tool and policy version against the same repo state and ref should reproduce this exact assessment.*