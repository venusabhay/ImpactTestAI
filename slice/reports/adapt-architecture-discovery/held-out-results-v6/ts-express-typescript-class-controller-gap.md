...
*Generated 2026-08-27T17:10:55.848810+00:00Z from repository at `/tmp/ts-express-heldout`, comparing working tree against `HEAD` (HEAD `983fa04136`).*
...
- No route or middleware relationship was discovered for src/api/user/userController.ts -- this may be a file outside this analyzer's discovery scope (see slice/ARCHITECTURE_DISCOVERY_DESIGN.md), not necessarily a file with no real impact.
