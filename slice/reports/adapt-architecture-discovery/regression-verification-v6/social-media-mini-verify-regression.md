...
*Generated 2026-08-27T17:02:29.888832+00:00Z from repository at `/Users/abhay/git-venusabhay/social-media-mini`, comparing working tree against `HEAD` (HEAD `b6fd0644e0`).*
...
(node:43160) ExperimentalWarning: VM Modules is an experimental feature and might change at any time
(Use `node --trace-warnings ...` to show where the warning was created)
FAIL ./verify-cross-service.integration.test.js (13.97 s)
...
> node --experimental-vm-modules node_modules/jest/bin/jest.js --detectOpenHandles --forceExit
    ...
    ✓ should get all posts (108 ms)
    ✓ should reject request without token (32 ms)
  Post Service - GET /:postId
    ✓ should get post by ID (33 ms)
    ✓ should return 404 for non-existent post (42 ms)
  Post Service - PUT /:postId
    ✓ should update own post (47 ms)
    ✓ should not update another user's post (27 ms)
  Post Service - DELETE /:postId
    ✓ should delete own post (37 ms)
    ✓ should not delete another user's post (28 ms)
  Post Service - PUT /:postId/like
    ✓ should like a post (40 ms)
    ✓ should not like same post twice (46 ms)
  Post Service - PUT /:postId/unlike
    ✓ should unlike a post (41 ms)
  Post Service - POST /:postId/comments
    ✓ should add a comment to post (44 ms)
    ✓ should not add empty comment (25 ms)

Test Suites: 1 passed, 1 total
Tests:       18 passed, 18 total
Snapshots:   0 total
Time:        11.843 s, estimated 15 s
Ran all test suites.
```
</details>
...
(node:43326) ExperimentalWarning: VM Modules is an experimental feature and might change at any time
(Use `node --trace-warnings ...` to show where the warning was created)
PASS ./user.test.js (11.483 s)
  User Service - GET /me
    ✓ should get current user profile (404 ms)
    ✓ should reject request without token (56 ms)
  User Service - PUT /me
    ✓ should update user profile (127 ms)
    ✓ should not update email (63 ms)
    ✓ should reject request without token (34 ms)
  User Service - GET /:userId
    ✓ should get user by ID (49 ms)
    ✓ should return 404 for non-existent user (44 ms)
  User Service - GET /search
    ✓ should search users by name (90 ms)
    ✓ should return empty array for no matches (74 ms)
    ✓ should require query parameter (57 ms)

Test Suites: 1 passed, 1 total
Tests:       10 passed, 10 total
Snapshots:   0 total
Time:        11.807 s, estimated 16 s
Ran all test suites.
```
</details>
